%Esta función extrae el ciclo anual y luego estandariza un campo de
%d1xd2xtiempo
function  y=cicloanual_estan(x,time)
%% entrada
%x = campo
%time = vector de tiempo en idioma matlab
%% salida
%%y= campo sin el ciclo anual y estandarizado
%% 
%%
D=size(x);   %dimesiones del campo x
